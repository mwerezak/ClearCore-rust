...
typedef union { //  to avoid read-modify-write on write-to-clear register
  struct {
     ...
     uint32_t FLASH_ALT_:1;     /*!< bit:      1  FLASH_ALT                          */
     uint32_t SEEPROM_:1;       /*!< bit:      2  SEEPROM                            */
     uint32_t RAMCM4S_:1;       /*!< bit:      3  RAMCM4S                            */
     uint32_t RAMPPPDSU_:1;     /*!< bit:      4  RAMPPPDSU                          */
     uint32_t RAMDMAWR_:1;      /*!< bit:      5  RAMDMAWR                           */
     uint32_t RAMDMACICM_:1;    /*!< bit:      6  RAMDMACICM                         */
     uint32_t HPB0_:1;          /*!< bit:      7  HPB0                               */
     uint32_t HPB1_:1;          /*!< bit:      8  HPB1                               */
     uint32_t HPB2_:1;          /*!< bit:      9  HPB2                               */
     uint32_t HPB3_:1;          /*!< bit:     10  HPB3                               */
     uint32_t PUKCC_:1;         /*!< bit:     11  PUKCC                              */
     uint32_t SDHC0_:1;         /*!< bit:     12  SDHC0                              */
     uint32_t SDHC1_:1;         /*!< bit:     13  SDHC1                              */
     uint32_t QSPI_:1;          /*!< bit:     14  QSPI                               */
     uint32_t BKUPRAM_:1;       /*!< bit:     15  BKUPRAM                            */
...
typedef union { //  to avoid read-modify-write on write-to-clear register
  struct {
     ...
     uint32_t SERCOM0_:1;       /*!< bit:     12  SERCOM0                            */
     uint32_t SERCOM1_:1;       /*!< bit:     13  SERCOM1                            */
     uint32_t TC0_:1;           /*!< bit:     14  TC0                                */
     uint32_t TC1_:1;           /*!< bit:     15  TC1                                */
     uint32_t :16;              /*!< bit: 16..31  Reserved                           */
  } bit;                       /*!< Structure used for bit  access                  */
  uint32_t reg;                /*!< Type      used for register access              */
} PAC_INTFLAGA_Type;
...
typedef union { //  to avoid read-modify-write on write-to-clear register
  struct {
     ...
     uint32_t CMCC_:1;          /*!< bit:      3  CMCC                               */
     uint32_t PORT_:1;          /*!< bit:      4  PORT                               */
     uint32_t DMAC_:1;          /*!< bit:      5  DMAC                               */
     uint32_t HMATRIX_:1;       /*!< bit:      6  HMATRIX                            */
     uint32_t EVSYS_:1;         /*!< bit:      7  EVSYS                              */
     uint32_t :1;               /*!< bit:      8  Reserved                           */
     uint32_t SERCOM2_:1;       /*!< bit:      9  SERCOM2                            */
     uint32_t SERCOM3_:1;       /*!< bit:     10  SERCOM3                            */
     uint32_t TCC0_:1;          /*!< bit:     11  TCC0                               */
     uint32_t TCC1_:1;          /*!< bit:     12  TCC1                               */
     uint32_t TC2_:1;           /*!< bit:     13  TC2                                */
     uint32_t TC3_:1;           /*!< bit:     14  TC3                                */
     uint32_t :1;               /*!< bit:     15  Reserved                           */
     uint32_t RAMECC_:1;        /*!< bit:     16  RAMECC                             */
...
typedef union { //  to avoid read-modify-write on write-to-clear register
  struct {
     ...
     uint32_t GMAC_:1;          /*!< bit:      2  GMAC                               */
     uint32_t TCC2_:1;          /*!< bit:      3  TCC2                               */
     uint32_t TCC3_:1;          /*!< bit:      4  TCC3                               */
     uint32_t TC4_:1;           /*!< bit:      5  TC4                                */
     uint32_t TC5_:1;           /*!< bit:      6  TC5                                */
     uint32_t PDEC_:1;          /*!< bit:      7  PDEC                               */
     uint32_t AC_:1;            /*!< bit:      8  AC                                 */
     uint32_t AES_:1;           /*!< bit:      9  AES                                */
     uint32_t TRNG_:1;          /*!< bit:     10  TRNG                               */
     uint32_t ICM_:1;           /*!< bit:     11  ICM                                */
     uint32_t PUKCC_:1;         /*!< bit:     12  PUKCC                              */
     uint32_t QSPI_:1;          /*!< bit:     13  QSPI                               */
     uint32_t CCL_:1;           /*!< bit:     14  CCL                                */
...
typedef union { //  to avoid read-modify-write on write-to-clear register
  struct {
     uint32_t SERCOM4_:1;       /*!< bit:      0  SERCOM4                            */
     uint32_t SERCOM5_:1;       /*!< bit:      1  SERCOM5                            */
     uint32_t SERCOM6_:1;       /*!< bit:      2  SERCOM6                            */
     uint32_t SERCOM7_:1;       /*!< bit:      3  SERCOM7                            */
     uint32_t TCC4_:1;          /*!< bit:      4  TCC4                               */
     uint32_t TC6_:1;           /*!< bit:      5  TC6                                */
     uint32_t TC7_:1;           /*!< bit:      6  TC7                                */
     uint32_t ADC0_:1;          /*!< bit:      7  ADC0                               */
     uint32_t ADC1_:1;          /*!< bit:      8  ADC1                               */
     uint32_t DAC_:1;           /*!< bit:      9  DAC                                */
     uint32_t I2S_:1;           /*!< bit:     10  I2S                                */
     uint32_t PCC_:1;           /*!< bit:     11  PCC                                */
...
typedef struct {
  ...
  __IO PAC_INTFLAGD_Type         INTFLAGD;    /**< \brief Offset: 0x20 (R/W 32) Peripheral interrupt flag status - Bridge D */
    ...
    PAC_STATUSA_Type          STATUSA;     /**< \brief Offset: 0x34 (R/  32) Peripheral write protection status - Bridge A */
    PAC_STATUSB_Type          STATUSB;     /**< \brief Offset: 0x38 (R/  32) Peripheral write protection status - Bridge B */
    PAC_STATUSC_Type          STATUSC;     /**< \brief Offset: 0x3C (R/  32) Peripheral write protection status - Bridge C */
    PAC_STATUSD_Type          STATUSD;     /**< \brief Offset: 0x40 (R/  32) Peripheral write protection status - Bridge D */
} Pac;
#endif /* !(defined(__ASSEMBLY__) || defined(__IAR_SYSTEMS_ASM__)) */
