...
typedef union { //  to avoid read-modify-write on write-to-clear register
  struct {
     uint8_t  UNDERRUN0:1;      /*!< bit:      0  Result 0 Underrun                  */
     uint8_t  UNDERRUN1:1;      /*!< bit:      1  Result 1 Underrun                  */
     uint8_t  EMPTY0:1;         /*!< bit:      2  Data Buffer 0 Empty                */
     uint8_t  EMPTY1:1;         /*!< bit:      3  Data Buffer 1 Empty                */
     uint8_t  RESRDY0:1;        /*!< bit:      4  Result 0 Ready                     */
     uint8_t  RESRDY1:1;        /*!< bit:      5  Result 1 Ready                     */
     uint8_t  OVERRUN0:1;       /*!< bit:      6  Result 0 Overrun                   */
     uint8_t  OVERRUN1:1;       /*!< bit:      7  Result 1 Overrun                   */
  } bit;                       /*!< Structure used for bit  access                  */
  struct {
     uint8_t  UNDERRUN:2;       /*!< bit:  0.. 1  Result x Underrun                  */
     uint8_t  EMPTY:2;          /*!< bit:  2.. 3  Data Buffer x Empty                */
     uint8_t  RESRDY:2;         /*!< bit:  4.. 5  Result x Ready                     */
     uint8_t  OVERRUN:2;        /*!< bit:  6.. 7  Result x Overrun                   */
  } vec;                       /*!< Structure used for vec  access                  */
  uint8_t reg;                 /*!< Type      used for register access              */
} DAC_INTFLAG_Type;
#endif /* !(defined(__ASSEMBLY__) || defined(__IAR_SYSTEMS_ASM__)) */
...
typedef struct {
  ...
  __IO DAC_INTFLAG_Type          INTFLAG;     /**< \brief Offset: 0x06 (R/W  8) Interrupt Flag Status and Clear */
    DAC_STATUS_Type           STATUS;      /**< \brief Offset: 0x07 (R/   8) Status */
    DAC_SYNCBUSY_Type         SYNCBUSY;    /**< \brief Offset: 0x08 (R/  32) Synchronization Busy */
  ...
  __IO DAC_DBGCTRL_Type          DBGCTRL;     /**< \brief Offset: 0x18 (R/W  8) Debug Control */
    ...
    DAC_RESULT_Type           RESULT[2];   /**< \brief Offset: 0x1C (R/  16) Filter Result */
} Dac;
#endif /* !(defined(__ASSEMBLY__) || defined(__IAR_SYSTEMS_ASM__)) */
