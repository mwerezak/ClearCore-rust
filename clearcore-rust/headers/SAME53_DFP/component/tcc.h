...
typedef union { //  to avoid read-modify-write on write-to-clear register
  struct {
     ...
     uint32_t MC4:1;            /*!< bit:     20  Match or Capture 4                 */
     uint32_t MC5:1;            /*!< bit:     21  Match or Capture 5                 */
     uint32_t :10;              /*!< bit: 22..31  Reserved                           */
  } bit;                       /*!< Structure used for bit  access                  */
  struct {
     uint32_t :16;              /*!< bit:  0..15  Reserved                           */
     uint32_t MC:6;             /*!< bit: 16..21  Match or Capture x                 */
     uint32_t :10;              /*!< bit: 22..31  Reserved                           */
  } vec;                       /*!< Structure used for vec  access                  */
  uint32_t reg;                /*!< Type      used for register access              */
} TCC_INTFLAG_Type;
...
typedef struct {
  ...
  __IO TCC_CTRLBSET_Type         CTRLBSET;    /**< \brief Offset: 0x05 (R/W  8) Control B Set */
    ...
    TCC_SYNCBUSY_Type         SYNCBUSY;    /**< \brief Offset: 0x08 (R/  32) Synchronization Busy */
