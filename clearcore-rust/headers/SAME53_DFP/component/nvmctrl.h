...
typedef union { //  to avoid read-modify-write on write-to-clear register
  struct {
     uint16_t DONE:1;           /*!< bit:      0  Command Done                       */
     uint16_t ADDRE:1;          /*!< bit:      1  Address Error                      */
     uint16_t PROGE:1;          /*!< bit:      2  Programming Error                  */
     uint16_t LOCKE:1;          /*!< bit:      3  Lock Error                         */
     uint16_t ECCSE:1;          /*!< bit:      4  ECC Single Error                   */
     uint16_t ECCDE:1;          /*!< bit:      5  ECC Dual Error                     */
     uint16_t NVME:1;           /*!< bit:      6  NVM Error                          */
     uint16_t SUSP:1;           /*!< bit:      7  Suspended Write Or Erase Operation */
     uint16_t SEESFULL:1;       /*!< bit:      8  Active SEES Full                   */
     uint16_t SEESOVF:1;        /*!< bit:      9  Active SEES Overflow               */
     uint16_t SEEWRC:1;         /*!< bit:     10  SEE Write Completed                */
     uint16_t :5;               /*!< bit: 11..15  Reserved                           */
  } bit;                       /*!< Structure used for bit  access                  */
  uint16_t reg;                /*!< Type      used for register access              */
...
typedef struct {
  ...
  __O  NVMCTRL_CTRLB_Type        CTRLB;       /**< \brief Offset: 0x04 ( /W 16) Control B */
    ...
    NVMCTRL_PARAM_Type        PARAM;       /**< \brief Offset: 0x08 (R/  32) NVM Parameter */
  ...
  __IO NVMCTRL_INTFLAG_Type      INTFLAG;     /**< \brief Offset: 0x10 (R/W 16) Interrupt Flag Status and Clear */
    NVMCTRL_STATUS_Type       STATUS;      /**< \brief Offset: 0x12 (R/  16) Status */
  __IO NVMCTRL_ADDR_Type         ADDR;        /**< \brief Offset: 0x14 (R/W 32) Address */
    NVMCTRL_RUNLOCK_Type      RUNLOCK;     /**< \brief Offset: 0x18 (R/  32) Lock Section */
    NVMCTRL_PBLDATA_Type      PBLDATA[2];  /**< \brief Offset: 0x1C (R/  32) Page Buffer Load Data x */
    NVMCTRL_ECCERR_Type       ECCERR;      /**< \brief Offset: 0x24 (R/  32) ECC Error Status Register */
  ...
  __IO NVMCTRL_SEECFG_Type       SEECFG;      /**< \brief Offset: 0x2A (R/W  8) SmartEEPROM Configuration Register */
    ...
    NVMCTRL_SEESTAT_Type      SEESTAT;     /**< \brief Offset: 0x2C (R/  32) SmartEEPROM Status Register */
} Nvmctrl;
#endif /* !(defined(__ASSEMBLY__) || defined(__IAR_SYSTEMS_ASM__)) */
