...
typedef union { //  to avoid read-modify-write on write-to-clear register
  struct {
     uint32_t RXC:1;            /*!< bit:      0  Receive Data Register Full         */
     uint32_t DRE:1;            /*!< bit:      1  Transmit Data Register Empty       */
     uint32_t TXC:1;            /*!< bit:      2  Transmission Complete              */
     uint32_t ERROR:1;          /*!< bit:      3  Overrun Error                      */
     uint32_t :4;               /*!< bit:  4.. 7  Reserved                           */
     uint32_t CSRISE:1;         /*!< bit:      8  Chip Select Rise                   */
     uint32_t :1;               /*!< bit:      9  Reserved                           */
     uint32_t INSTREND:1;       /*!< bit:     10  Instruction End                    */
     uint32_t :21;              /*!< bit: 11..31  Reserved                           */
  } bit;                       /*!< Structure used for bit  access                  */
  uint32_t reg;                /*!< Type      used for register access              */
} QSPI_INTFLAG_Type;
...
typedef struct {
  ...
  __IO QSPI_BAUD_Type            BAUD;        /**< \brief Offset: 0x08 (R/W 32) Baud Rate */
    QSPI_RXDATA_Type          RXDATA;      /**< \brief Offset: 0x0C (R/  32) Receive Data */
  ...
  __IO QSPI_INTFLAG_Type         INTFLAG;     /**< \brief Offset: 0x1C (R/W 32) Interrupt Flag Status and Clear */
    QSPI_STATUS_Type          STATUS;      /**< \brief Offset: 0x20 (R/  32) Status Register */
