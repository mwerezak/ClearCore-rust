...
typedef union { //  to avoid read-modify-write on write-to-clear register
  struct {
     ...
     uint16_t :4;               /*!< bit: 10..13  Reserved                           */
     uint16_t TAMPER:1;         /*!< bit:     14  Tamper                             */
...
typedef union { //  to avoid read-modify-write on write-to-clear register
  struct {
     ...
     uint16_t CMP0:1;           /*!< bit:      8  Compare 0                          */
     uint16_t CMP1:1;           /*!< bit:      9  Compare 1                          */
     uint16_t CMP2:1;           /*!< bit:     10  Compare 2                          */
     uint16_t CMP3:1;           /*!< bit:     11  Compare 3                          */
     uint16_t :2;               /*!< bit: 12..13  Reserved                           */
     uint16_t TAMPER:1;         /*!< bit:     14  Tamper                             */
     uint16_t OVF:1;            /*!< bit:     15  Overflow                           */
  } bit;                       /*!< Structure used for bit  access                  */
  struct {
     uint16_t PER:8;            /*!< bit:  0.. 7  Periodic Interval x                */
     uint16_t CMP:4;            /*!< bit:  8..11  Compare x                          */
     uint16_t :4;               /*!< bit: 12..15  Reserved                           */
  } vec;                       /*!< Structure used for vec  access                  */
  uint16_t reg;                /*!< Type      used for register access              */
...
typedef union { //  to avoid read-modify-write on write-to-clear register
  struct {
     ...
     uint16_t ALARM1:1;         /*!< bit:      9  Alarm 1                            */
     uint16_t :4;               /*!< bit: 10..13  Reserved                           */
     uint16_t TAMPER:1;         /*!< bit:     14  Tamper                             */
     uint16_t OVF:1;            /*!< bit:     15  Overflow                           */
  } bit;                       /*!< Structure used for bit  access                  */
  struct {
     uint16_t PER:8;            /*!< bit:  0.. 7  Periodic Interval x                */
     uint16_t ALARM:2;          /*!< bit:  8.. 9  Alarm x                            */
     uint16_t :6;               /*!< bit: 10..15  Reserved                           */
  } vec;                       /*!< Structure used for vec  access                  */
  uint16_t reg;                /*!< Type      used for register access              */
...
typedef struct { /* 32-bit Counter with Single 32-bit Compare */
  ...
  __IO RTC_DBGCTRL_Type          DBGCTRL;     /**< \brief Offset: 0x0E (R/W  8) Debug Control */
    ...
    RTC_MODE0_SYNCBUSY_Type   SYNCBUSY;    /**< \brief Offset: 0x10 (R/  32) MODE0 Synchronization Busy Status */
  ...
  __IO RTC_TAMPCTRL_Type         TAMPCTRL;    /**< \brief Offset: 0x60 (R/W 32) Tamper Control */
    RTC_MODE0_TIMESTAMP_Type  TIMESTAMP;   /**< \brief Offset: 0x64 (R/  32) MODE0 Timestamp */
...
typedef struct { /* 16-bit Counter with Two 16-bit Compares */
  ...
  __IO RTC_DBGCTRL_Type          DBGCTRL;     /**< \brief Offset: 0x0E (R/W  8) Debug Control */
       RoReg8                    Reserved1[0x1];
    RTC_MODE1_SYNCBUSY_Type   SYNCBUSY;    /**< \brief Offset: 0x10 (R/  32) MODE1 Synchronization Busy Status */
  __IO RTC_FREQCORR_Type         FREQCORR;    /**< \brief Offset: 0x14 (R/W  8) Frequency Correction */
       RoReg8                    Reserved2[0x3];
  ...
  __IO RTC_TAMPCTRL_Type         TAMPCTRL;    /**< \brief Offset: 0x60 (R/W 32) Tamper Control */
    RTC_MODE1_TIMESTAMP_Type  TIMESTAMP;   /**< \brief Offset: 0x64 (R/  32) MODE1 Timestamp */
  __IO RTC_TAMPID_Type           TAMPID;      /**< \brief Offset: 0x68 (R/W 32) Tamper ID */
...
typedef struct { /* Clock/Calendar with Alarm */
  ...
  __IO RTC_DBGCTRL_Type          DBGCTRL;     /**< \brief Offset: 0x0E (R/W  8) Debug Control */
       RoReg8                    Reserved1[0x1];
    RTC_MODE2_SYNCBUSY_Type   SYNCBUSY;    /**< \brief Offset: 0x10 (R/  32) MODE2 Synchronization Busy Status */
  __IO RTC_FREQCORR_Type         FREQCORR;    /**< \brief Offset: 0x14 (R/W  8) Frequency Correction */
       RoReg8                    Reserved2[0x3];
  ...
  __IO RTC_GP_Type               GP[4];       /**< \brief Offset: 0x40 (R/W 32) General Purpose */
       RoReg8                    Reserved5[0x10];
  __IO RTC_TAMPCTRL_Type         TAMPCTRL;    /**< \brief Offset: 0x60 (R/W 32) Tamper Control */
    RTC_MODE2_TIMESTAMP_Type  TIMESTAMP;   /**< \brief Offset: 0x64 (R/  32) MODE2 Timestamp */
  __IO RTC_TAMPID_Type           TAMPID;      /**< \brief Offset: 0x68 (R/W 32) Tamper ID */
       RoReg8                    Reserved6[0x14];
  __IO RTC_BKUP_Type             BKUP[8];     /**< \brief Offset: 0x80 (R/W 32) Backup */
} RtcMode2;
