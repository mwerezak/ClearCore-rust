...
//      typedef typename std::iterator_traits<_Tp>::value_type _V;
      (void)*;                       // require dereference operator
    }
    _Tp ;
  };
  ...
  struct _Mutable_TrivialIteratorConcept
  {
    void __constraints() {
      ...
      * = *__j;                      // require dereference and assignment
    }
    _Tp , __j;
  };
...
//      __function_requires< _SignedIntegerConcept<_Diff> >();
  ...
  struct _OutputIteratorConcept
  {
    void __constraints() {
      ...
      ++;                            // require preincrement operator
      ++;                            // require postincrement operator
      *++ = __t;                     // require postincrement and assignment
    }
    _Tp ;
    _ValueT __t;
  };
  ...
  struct _RandomAccessIteratorConcept
  {
    void __constraints() {
      ...
      typedef typename std::iterator_traits<_Tp>::reference _Ref;
       ...
       += __n;                       // require assignment addition operator
       =  + __n;  = __n + ; // require addition with difference type
       -= __n;                       // require assignment subtraction op
       =  - __n;                  // require subtraction with
                                        //            difference type
      __n =  - __j;                  // require difference operator
      (void)[__n];                   // require element access operator
    }
    _Tp __a, __b;
    _Tp , __j;
  ...
  struct _Mutable_RandomAccessIteratorConcept
  {
    void __constraints() {
      ...
      [__n] = *;                  // require element access and assignment
    }
    _Tp ;
    typename std::iterator_traits<_Tp>::difference_type __n;
  };
  ...
  struct _ReversibleContainerConcept
  {
    ...
    void __constraints() {
      ...
      _Const_reverse_iterator  = __c.rbegin();
       = __c.rend();
    }
  };
