...
_GLIBCXX_BEGIN_NAMESPACE_VERSION
  ...
  public:
    ...
    {
      unsigned  = _M_load(__mo);
      if (( & ~_Waiter_bit) != __val)
	return ( & ~_Waiter_bit);
      // TODO Spin-wait first.
      return _M_load_and_test(, __val, false, __mo);
    }
	...
	return;
      // TODO Spin-wait first.
      _M_load_and_test(, __val, true, __mo);
    }
	...
	return true;
      // TODO Spin-wait first.  Ignore effect on timeout.
       = _M_load_and_test_until_impl(, __val, true, __mo, __atime);
      return ( & ~_Waiter_bit) == __val;
    }
