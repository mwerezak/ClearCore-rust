...
_GLIBCXX_BEGIN_NAMESPACE_VERSION
  ...
  template<typename _Cond>
    struct throw_value_base : public _Cond
    {
      ...
      explicit throw_value_base(const std::size_t ) : _M_i()
      { throw_conditionally(); }
#endif
  ...
  struct throw_value_limit : public throw_value_base<limit_condition>
  {
    ...
    explicit throw_value_limit(const std::size_t ) : base_type() { }
#endif
  ...
  struct throw_value_random : public throw_value_base<random_condition>
  {
    ...
    explicit throw_value_random(const std::size_t ) : base_type() { }
#endif
