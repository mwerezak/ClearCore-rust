...
namespace __gnu_parallel
{
  ...
  template<typename _It>
    struct __for_each_selector : public __generic_for_each_selector<_It>
    {
       ...
       *  @param __o Operator.
       *  @param  iterator referencing object. */
      template<typename _Op>
        bool
        operator()(_Op& __o, _It )
        {
          __o(*);
          return true;
        }
  ...
  template<typename _It>
    struct __transform2_selector : public __generic_for_each_selector<_It>
    {
      ...
      template<typename _Op>
        ...
        operator()(_Op& __o, _It )
        {
          *._M_third = __o(*._M_first, *._M_second);
          return true;
        }
    };
  ...
  template<typename _It>
    ...
    : public __generic_for_each_selector<_It>
    {
      template<typename _Op>
        ...
        operator()(_Op& __o, _It )
        {
          typename _It::first_type __go_back_one = .first;
          --__go_back_one;
          *.second = __o(*.first, *__go_back_one);
          return true;
        }
    };
