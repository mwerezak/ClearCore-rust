...
_GLIBCXX_BEGIN_NAMESPACE_VERSION
  ...
  template<class _Dom>
    ...
    public:
      ...
      _GBase (const _Dom& __e, const valarray<size_t>& )
      : _M_expr (__e), _M_index() {}
      
      value_type
      operator[] (size_t ) const
      { return _M_expr[_M_index[]]; }
  ...
  template<typename _Tp>
    ...
    public:
      ...
      _GBase (_Array<_Tp> __a, const valarray<size_t>& )
      : _M_array (__a), _M_index() {}
      
      value_type
      operator[] (size_t ) const
      { return _M_array._M_data[_M_index[]]; }
  ...
  template<class _Dom>
    ...
    : _GBase<_Dom>
    {
      ...
      _GClos (const _Dom& __e, const valarray<size_t>& )
      : _Base (__e, ) {}
    };
  ...
  template<typename _Tp>
    ...
    : _GBase<_Array<_Tp> >
    {
      ...
      _GClos (_Array<_Tp> __a, const valarray<size_t>& )
      : _Base (__a, ) {}
    };
  ...
  template<class _Dom>
    ...
    public:
      ...
      _IBase (const _Dom& __e, const valarray<size_t>& )
      : _M_expr (__e), _M_index () {}
  ...
  template<class _Dom>
    ...
    : _IBase<_Dom>
    {
      ...
      _IClos (const _Dom& __e, const valarray<size_t>& )
      : _Base (__e, ) {}
    };
  ...
  template<typename _Tp>
    ...
    : _IBase<valarray<_Tp> >
    {
      ...
      _IClos (const valarray<_Tp>& __a, const valarray<size_t>& )
      : _Base (__a, ) {}
    };
  ...
  template<class _Clos, typename _Tp>
    inline _Tp
    _Expr<_Clos, _Tp>::operator[](size_t ) const
    { return _M_closure[]; }
  ...
  template<class _Clos, typename _Tp>
    inline valarray<_Tp>
    _Expr<_Clos, _Tp>::operator[](const valarray<size_t>& ) const
    {
