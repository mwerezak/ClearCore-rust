...
_GLIBCXX_BEGIN_NAMESPACE_VERSION
  ...
  */
  template<typename _ForwardIterator, typename _Integer,
      ...
      while (__first != __last)
	{
	  ...
	  ++;
	  while ( != __last && __n != 1 && __unary_pred())
	    {
	      ++;
	      --__n;
	    }
	  ...
	  if ( == __last)
	    return __last;
	  __first = std::__find_if(++, __last, __unary_pred);
	}
      return __last;
    }
  ...
  */
  ...
  template<typename _RandomAccessIterator, typename _Compare>
		  ...
		  _RandomAccessIterator __last, _Compare __comp)
    {
      ...
      for (_RandomAccessIterator  = __middle;  < __last; ++)
	if (__comp(, __first))
	  std::__pop_heap(__first, __middle, , __comp);
    }
  ...
  */
  ...
  template<typename _RandomAccessIterator, typename _Compare>
		     ...
		     _RandomAccessIterator __last, _Compare __comp)
    {
      ...
      for (_RandomAccessIterator  = __first + 1;  != __last; ++)
	{
	  if (__comp(, __first))
	    {
	      typename iterator_traits<_RandomAccessIterator>::value_type
		__val = _GLIBCXX_MOVE(*);
	      _GLIBCXX_MOVE_BACKWARD3(__first, ,  + 1);
  ...
  template<typename _RandomAccessIterator, typename _Compare>
    ...
    __unguarded_insertion_sort(_RandomAccessIterator __first,
			       _RandomAccessIterator __last, _Compare __comp)
    {
      for (_RandomAccessIterator  = __first;  != __last; ++)
	std::__unguarded_linear_insert(,
				__gnu_cxx::__ops::__val_comp_iter(__comp));
    }
  ...
  */
  template<typename _ForwardIterator, typename _Tp, typename _Compare>
	...
	= std::__lower_bound(__first, __last, __val,
			     __gnu_cxx::__ops::__iter_comp_val(__comp));
      return  != __last && !bool(__comp(__val, *));
    }
  ...
  */
  template<typename _RandomAccessIterator,
	...
	_DistanceType;
      ...
      for (_RandomAccessIterator  = __first + 1;  != __last; ++)
	std::iter_swap(, __first + __d(__g, __p_type(0,  - __first)));
    }
#endif
  ...
  */
  template<typename _RandomAccessIterator, typename _RandomNumberGenerator>
	...
	return;
      for (_RandomAccessIterator  = __first + 1;  != __last; ++)
	{
	  _RandomAccessIterator __j = __first + __rand(( - __first) + 1);
	  if ( != __j)
	    std::iter_swap(, __j);
	}
    }
