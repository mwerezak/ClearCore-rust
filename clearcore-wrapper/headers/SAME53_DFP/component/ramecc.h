...
typedef union { //  to avoid read-modify-write on write-to-clear register
  struct {
     uint8_t  SINGLEE:1;        /*!< bit:      0  Single Bit ECC Error Interrupt     */
     uint8_t  DUALE:1;          /*!< bit:      1  Dual Bit ECC Error Interrupt       */
     uint8_t  :6;               /*!< bit:  2.. 7  Reserved                           */
  } bit;                       /*!< Structure used for bit  access                  */
  uint8_t reg;                 /*!< Type      used for register access              */
} RAMECC_INTFLAG_Type;
...
typedef struct {
  ...
  __IO RAMECC_INTFLAG_Type       INTFLAG;     /**< \brief Offset: 0x2 (R/W  8) Interrupt Flag */
    RAMECC_STATUS_Type        STATUS;      /**< \brief Offset: 0x3 (R/   8) Status */
    RAMECC_ERRADDR_Type       ERRADDR;     /**< \brief Offset: 0x4 (R/  32) Error Address */
