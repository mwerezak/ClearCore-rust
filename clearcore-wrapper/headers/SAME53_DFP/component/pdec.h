...
typedef union { //  to avoid read-modify-write on write-to-clear register
  struct {
     uint8_t  OVF:1;            /*!< bit:      0  Overflow/Underflow                 */
     uint8_t  ERR:1;            /*!< bit:      1  Error                              */
     uint8_t  DIR:1;            /*!< bit:      2  Direction Change                   */
     uint8_t  VLC:1;            /*!< bit:      3  Velocity                           */
     uint8_t  MC0:1;            /*!< bit:      4  Channel 0 Compare Match            */
     uint8_t  MC1:1;            /*!< bit:      5  Channel 1 Compare Match            */
     uint8_t  :2;               /*!< bit:  6.. 7  Reserved                           */
  } bit;                       /*!< Structure used for bit  access                  */
  struct {
     uint8_t  :4;               /*!< bit:  0.. 3  Reserved                           */
     uint8_t  MC:2;             /*!< bit:  4.. 5  Channel x Compare Match            */
     uint8_t  :2;               /*!< bit:  6.. 7  Reserved                           */
  } vec;                       /*!< Structure used for vec  access                  */
  uint8_t reg;                 /*!< Type      used for register access              */
} PDEC_INTFLAG_Type;
...
typedef struct {
  ...
  __IO PDEC_DBGCTRL_Type         DBGCTRL;     /**< \brief Offset: 0x0F (R/W  8) Debug Control */
    PDEC_SYNCBUSY_Type        SYNCBUSY;    /**< \brief Offset: 0x10 (R/  32) Synchronization Status */
